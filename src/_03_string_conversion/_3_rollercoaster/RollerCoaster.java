...
public class RollerCoaster {
	...
	int heightAsInt = Integer.parseInt(heightToRide);
		...
		if (heightAsInt >= 48) {
			JOptionPane.showMessageDialog(null, "You are tall enough to ride the roller coaster alone.");
		}
		...
		// "You can ride the coaster with someone else!" 
			...
			JOptionPane.showMessageDialog(null, "You can ride this coaster with someone 18 years of age or older.");
		}
