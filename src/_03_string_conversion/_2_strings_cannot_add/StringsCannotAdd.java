...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			String Message = JOptionPane.showInputDialog("Enter a number");
			// 4) Print the addition of fourAsString and sixAsString using JOptionPane 
			int Randy = Integer.parseInt(Input);
			int Randall = Integer.parseInt(Message);
			JOptionPane.showMessageDialog(null, Randy + Randall);
			// Did you notice 46 instead of 4 + 6 = 10?
			
			// 5) Ask the user to enter number 5 and hold it in the variable fiveAsString 
			String fiveAsString = JOptionPane.showInputDialog("Enter a number 5");
			// 6) Print the addition of the variables fourAsString, sixAsString, and fiveAsString 
			String fourAsString = JOptionPane.showInputDialog("Enter a number 4");
			String sixAsString = JOptionPane.showInputDialog("Enter a nuber 6");
